 ...
 *
 * Created on Jan 31, 2013 10:11:30 PM
 *
    ...
    extends AbstractActionController
{
     ...
     * @return \Admin\Controller\LocalesController
     */
    ...
    public function indexAction()
    {
        ...
        try {
            $repository = $this->getEntityManager()->getRepository('Admin\Entity\Locales');
            $entities = $repository->findBy($criteria, $orderBy, $limit, $offset);
            $data = EntityHelper::toArrayRecursive($entities);
            $total = $this->getEntityManager()
                ->createQuery('SELECT COUNT(r) FROM Admin\Entity\Locales AS r')
